...
export default function Explore() {
  return (
    <section className="pt-20 w-full">
      <h2 className="text-3xl font-semibold text-gray-900 text-center mb-12 px-6 md:px-20">
        Explora Lo Mejor de La Romana a Solo Minutos de Stone Towers III
      </h2>
      <div className="grid grid-cols-2 lg:grid-cols-3" style={{ gap: "4px" }}>
        {locations.map((loc) => (
          <div key={loc.name} className="relative group overflow-hidden aspect-[4/3]">
            ...
            <div
              ...
              style={{ background: "linear-gradient(to bottom, rgba(0,0,0,0.7), rgba(0,0,0,0.01))" }}
            />
