              ...
              <div className="p-4">
                <div className="py-2 inline-block mb-2">
                  <p className="font-semibold text-base">
                    <span className="bg-gray-900 text-white rounded-full px-3 py-1 mr-1 text-sm">
                      USD $
                    </span>
                    1,000 Para Reservar
                  </p>
                ...
                <div className="flex gap-2 flex-wrap mb-3">
                  <span className="bg-gray-100 text-gray-700 text-xs px-3 py-1.5 rounded-full flex items-center gap-1.5">
                    <BedIcon /> {p.beds}
                  </span>
                  <span className="bg-gray-100 text-gray-700 text-xs px-3 py-1.5 rounded-full flex items-center gap-1.5">
                    <BathIcon /> {p.baths}
